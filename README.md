...
* **Content-Based (untuk anime "Bleach"):**
    ...
    ![Top 10 Rekomendasi Anime Mirip Bleach](https://user-images.githubusercontent.com/your-username/your-repo/blob/main/path-to-bleach-recommendation-image.png) Contoh Output:
